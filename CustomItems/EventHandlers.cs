        ...
        public void OnWaitingForPlayers()
        {
            if (first)
            {
                if (plugin.Config.SniperRifle)
                    new SniperRifle(plugin.Config.ItemConfigs.SniperCfg.ItemType, plugin.Config.ItemConfigs.SniperCfg.ClipSize, plugin.Config.ItemConfigs.SniperCfg.Id).RegisterCustomItem();
